...
function OtpPageInner() {
  ...
  }, [phone, router, setToken, setUser, setOnboardingCompleted]);
    ...
    >
      ...
      <AnimatePresence>
        {showHint && (
          ...
          >
            <span>کد آزمایشی: ۱۲۳۴۵۶</span>
            <button onClick={() => setShowHint(false)} className="text-emerald-500 hover:text-emerald-700">
              <X className="w-3 h-3" />
            </button>
          </motion.div>
        )}
      ...
      <p className="text-center text-xs text-gray-400 leading-relaxed mb-3">
        ایمیل/پیامک نرسید؟ پوشه اسپم رو چک کن یا دوباره بفرست
      </p>
      ...
      <div className="text-center mb-auto">
        ...
        >
          {countdown > 0 ? `ارسال مجدد کد (${countdown}ث)` : "ارسال مجدد کد"}
        </button>
      </div>
