    ...
    >
      ...
      >
        <div className="prose prose-sm max-w-none text-gray-700 space-y-5 pb-6">
          ...
          <p>
            جیبیار یک نرم‌افزار مدیریت مالی شخصی است که به کاربران کمک می‌کند بودجه ماهانه، هزینه‌ها و اهداف مالی خود را ردیابی و مدیریت کنند. همچنین یک دستیار هوش مصنوعی فارسی‌زبان برای مشاوره مالی ارائه می‌دهد. با استفاده از این سرویس، شما شرایط و ضوابط زیر را پذیرفته‌اید.
          </p>
          ...
          <p>
            استفاده از جیبیار برای افراد بالای ۱۸ سال مجاز است. با ثبت‌نام در این سرویس، تأیید می‌کنید که حداقل ۱۸ سال سن دارید. اگر والدین یا سرپرستی برای کاربر زیر ۱۸ سال ثبت‌نام می‌کنند، مسئولیت استفاده کودک بر عهده سرپرست قانونی است.
          </p>
          ...
          <p>
            جیبیار <strong>هیچ‌گونه اتصالی به حساب‌های بانکی شما ندارد</strong>. تمامی اطلاعات مالی (تراکنش‌ها، بودجه‌ها، اهداف) به صورت دستی توسط خود شما وارد می‌شود. ما اطلاعات زیر را جمع‌آوری می‌کنیم:
          </p>
          ...
          <p>
            دستیار هوشمند جیبیار اطلاعات عمومی و پیشنهادهای آموزشی ارائه می‌دهد. این پیشنهادها <strong>مشاوره مالی حرفه‌ای محسوب نمی‌شوند</strong> و جایگزین مشاور مالی مجاز نیستند. برای تصمیمات مالی مهم، حتماً با کارشناس مالی معتبر مشورت کنید.
          </p>

          <h3 className="text-base font-semibold text-[#2d1812]">۴.۲ محدودیت مسئولیت</h3>
          <p>
            جیبیار در قبال هیچ‌گونه خسارت مالی ناشی از تصمیماتی که بر اساس پیشنهادهای دستیار هوشمند گرفته‌اید، مسئولیتی نمی‌پذیرد.
          </p>
