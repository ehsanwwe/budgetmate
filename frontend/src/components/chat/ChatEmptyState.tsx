...
export default function ChatEmptyState({
  ...
  return (
    <div
      className="flex flex-col h-[calc(100vh-5rem)] md:h-[calc(100vh-2rem)] bg-[#f5f1eb]"
      dir="rtl"
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        ...
        <motion.div
          ...
          className="w-20 h-20 rounded-full bg-yellow-400 flex items-center justify-center shadow-md mb-6"
        >
          <Smile className="w-10 h-10 text-yellow-900" strokeWidth={2.2} />
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-3xl font-extrabold text-[#2d1812] mb-3"
        >
        ...
        <motion.p
          ...
          className="text-gray-600 leading-relaxed text-base max-w-xs"
        >
          من بادجت‌میتم،{" "}
      ...
      <motion.div
        ...
        className="shrink-0 px-4 pb-4 pt-2 space-y-3"
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            disabled={streaming}
            className="flex-1 rounded-full bg-white border border-gray-200 shadow-sm px-5 py-3 text-sm text-[#2d1812] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2d1812]/20"
          />
